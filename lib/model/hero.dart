...
//
//     final heroData = heroDataFromJson(jsonString);
...
class Result {
    ...
    factory Result.fromJson(Map<String, dynamic> json) {
        ...
        var imageUrl = json["image"] == null ? null : json["image"]["url"] as String?;

        if (imageUrl != null && imageUrl.contains('superherodb.com') && id != null && name != null) {
            final slug = name.toLowerCase()
                .replaceAll(RegExp(r'[^a-z0-9]+'), '-')
                .replaceAll(RegExp(r'-+'), '-')
                .replaceAll(RegExp(r'^-|-$'), '');
            imageUrl = 'https://akabab.github.io/superhero-api/api/images/md/$id-$slug.jpg';
        }
